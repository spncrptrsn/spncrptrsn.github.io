...
My take on Glenrock (outlined in full in [this chart](https://www.lucidchart.com/documents/view/04bf2714-35b7-4376-a7ae-37b7e30ab1db/0#)) gave Richard an ulterior motive for presenting the player with this task. If the player follows mayor Richard and Sabrina's requests without deviating from them, they'll be framed for the murder of Liam, the captain of the guard.
